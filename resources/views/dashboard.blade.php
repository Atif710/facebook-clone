            ...
            <div class="left">
                <div class="brand">
                    <a href="index.html" class="navbar-logo">
                        <img class="logo light-image" src="assets/img/logo/friendkit-bold.svg" width="112"
                            height="28" alt="">
                        <img class="logo dark-image" src="assets/img/logo/friendkit-white.svg" width="112"
                            height="28" alt="">
                    </a>
                </div>
                <div class="search">
...
>>>>>>> 84760dcc0601b260435729aac14f6eabc9f1c4e9
                            alt="">
                        <span class="indicator"></span>
                    </div>
...
>>>>>>> 84760dcc0601b260435729aac14f6eabc9f1c4e9
                                                    ...
                                                    <!-- Mood action -->
                                                    <div class="column is-6 is-narrower">
                                                        <div id="extended-show-activities"
                                                            class="compose-option is-centered">
                                                            <img src="assets/img/icons/emoji/emoji-1.svg"
                                                                alt="">
...
>>>>>>> 84760dcc0601b260435729aac14f6eabc9f1c4e9
                                                    ...
                                                    <div class="column is-6 is-narrower">
                                                        <div id="open-location-suboption"
                                                            class="compose-option is-centered">
                                                            <i data-feather="map-pin"></i>
...
>>>>>>> 84760dcc0601b260435729aac14f6eabc9f1c4e9
                                            ...
                                            <div class="more-wrap">
                                                <!-- View more button -->
                                                <button id="show-compose-friends" type="button"
                                                    class="button is-more" aria-haspopup="true">
                                                    <i data-feather="more-vertical"></i>
                                                    <span>View More</span>
                                                </button>
                                                <!-- Publish button -->
                            ...
                            <div class="card is-post">
                                ...
                                <div class="content-wrap">
                                    ...
                                    <div class="card-body">
                                        <!-- Post body text -->
                                        <div class="post-text">
                                            <p>You all know how i love bootstrap, but i didn't have time to dig deeper
                                                into it. Therefore i found this very
                                        ...
                                        <div class="post-link is-video">
                                            ...
                                            <div class="link-content">
                                                ...
                                                <p>Before I create the new Bootstrap 4 crash course I want to go over
                                                    some of the changes from Bootstrap
                                                    3.</p>
                                ...
                                <div class="content-wrap">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="post-text">
                                            <p>Thanks a lot to
                                                <a href="#">@Gaelle</a> and
                                                <a href="#">@Rolf</a> for this wonderful team lunch. The food
                                                was really tasty and we had some great laughs. Thanks
                            ...
                            <div class="card is-post">
                                ...
                                <div class="content-wrap">
                                    ...
                                    <div class="card-body">
                                        <!-- Post body text -->
                                        <div class="post-text">
                                            <p>Hey friends ! Iam back and i wanted to share with you some awesome
                                                pictures we took during our trip to Santa
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="post-text">
                                            <p>Just discovered this awesome CSS framework named
                                                ...
                                                and comes with so many mobile first modifiers. You
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="post-text">
                                            <p>Today, when i was walking back home from my job, i figured that i should
                                                ...
                                                in ThemeForest. As soon as i got back, i started working on this fresh
                                                and new project. Any suggestions
                                                about where i could find some interesting resources for social media
                                                design?
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="birthday-content">
                                            ...
                                            <button type="button" class="button light-button">Write
                                                Message</button>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <button type="button" class="button is-solid accent-button close-modal">Create a
                            Group</button>
                    </div>
                </div>
...
>>>>>>> 84760dcc0601b260435729aac14f6eabc9f1c4e9
                    ...
                    <div class="card-footer">
                        ...
                        <button type="button" class="button is-solid accent-button close-modal">Create
                            album</button>
                    </div>
                </div>
            </div>
        ...
        <div id="videos-modal" class="modal videos-modal is-xxl has-light-bg">
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    <div class="card-heading">
                        <h3>Go live</h3>
                        <div id="stop-stream" class="button is-solid accent-button is-hidden"
                            onclick="stopWebcam();">
                            ...
                            <div class="publication-meta">
                                <div class="inner-flex">
                                    <img id="share-modal-avatar" src="https://via.placeholder.com/300x300"
                                        data-demo-src="assets/img/avatars/dan.jpg" data-user-popover="1"
                                        alt="">
                                    <p id="share-modal-text">Yesterday with <a href="#">@Karen Miller</a> and
                                        <a href="#">@Marvin Stemperd</a> at the
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body has-text-centered">
                        ...
                        <p>Streaming is not allowed from mobile web. Please use our mobile apps for mobile streaming.
                        </p>

                        <div class="action">
                            <a href="index.html#demos-section"
                                class="button is-solid accent-button raised is-fullwidth">Got It</a>
                        </div>
                    </div>
                </div>
            </div>
