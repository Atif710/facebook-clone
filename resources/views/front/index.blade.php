                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="columns is-multiline is-full">
                                                    ...
                                                    <div class="column is-6 is-narrower">
                                                        <div class="compose-option is-centered">
                                                            ...
                                                            <input id="feed-upload-input-1" name="text_back_ground"
                                            ...
                                            <div id="basic-options" class="compose-options">
                                                ...
                                                <div class="compose-option">
                                                    <i data-feather="camera"></i>
                                                    <span>Media</span>
                                                    <input id="feed-upload-input-2" type="file" name="media"
                                                        type="file" accept=".png, .jpg, .jpeg"
                                                        onchange="readURL(this)">
                                                </div>
                                                <!-- Mood action -->
                                    ...
                                    <div class="content-wrap">
                                        ...
                                        <div class="card-heading">
                                            ...
                                            <div class="user-block">
                                                ...
                                                <div class="user-info">
                                                    <a href="#">{{ $fed->userName }}</a>
                                                    <span class="time">{{ $fed->posted_date }}</span>
                                                </div>
                                            </div>
                                            <!-- Right side dropdown -->
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <div class="reply">
                                                                    <form action="{{ url('feed') }}"
                                                                        ...
                                                                        <div class="media-content">
                                                                            <div class="field">
                                                                                {{-- <input type="hidden" name="postid" value="{{$feed->Id}}"> --}}
                                                                                <p class="control">
                                                                                    <textarea class="textarea comment-textarea" name="reply" rows="" placeholder="Reply..."></textarea>
                                                                                </p>
                                                                            </div>
                                                                            <!-- Additional actions -->
                                                                            <div class="actions">
                                                                                ...
                                                                                <div class="toolbar">
                                                                                    ...
                                                                                    <button type="submit""
                                                                                        class="button is-solid primary-button raised">Reply</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <form action="{{ url('comments') }}" method="post"
                                                    ...
                                                    <div class="media-content">
                                                        <div class="field">
                                                            {{-- <input type="hidden" name="postid" value="{{$feed->Id}}"> --}}
                                                            <p class="control">
                                                                <textarea class="textarea comment-textarea" name="comment" rows="" placeholder="Write a comment..."></textarea>
                                                            </p>
                                                        </div>
                                                        <!-- Additional actions -->
                                                        <div class="actions">
