...
<!-- Mirrored from friendkit.cssninja.io/navbar-v1-groups.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Aug 2022 09:17:36 GMT -->
<!-- Added by HTTrack -->
        ...
        <div class="container is-fluid">
            <div class="navbar-brand">
                <a href="index.html" class="navbar-item">
                    <img class="logo light-image" src="assets/img/logo/friendkit-bold.svg" width="112" height="28"
                        alt="">
                    <img class="logo dark-image" src="assets/img/logo/friendkit-white.svg" width="112" height="28"
                        alt="">
                </a>
            </div>
                            ...
                            <div class="inner">
                                ...
                                <div class="nav-drop-body is-friend-requests">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            <span>You are now friends with <a href="#">Elise Walker</a>. Check
                                                her <a href="#">profile</a>.</span>
                                        </div>
                                        <div class="media-right">
                                            <div class="added-icon">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            <span>You are now friends with <a href="#">Edward Mayers</a>. Check
                                                his <a href="#">profile</a>.</span>
                                        </div>
                                        <div class="media-right">
                                            <div class="added-icon">
                                                <i data-feather="tag"></i>
                            ...
                            <div class="inner">
                                ...
                                <div class="nav-drop-body is-notifications">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            <span><a href="#">Stella Bergmann</a> shared a <a href="#">New
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-content">
                                            <span><a href="#">Elise Walker</a> shared an <a
                                                    href="#">Image</a> with you an 2 other people.</span>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="./postgroup" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                
                                                <label for="group">Group Name</label>
                                                <input id="group" name="groupName" type="text" class="input" placeholder="Group Name" required>
                                                <label for="image">Group Image</label>
                                                <input id="image" name="groupImageUrl" type="file" class="input" placeholder="Group Image" required>
                                                <label for="description">Group Description</label>
                                                <input id="description" name="groupDescription" type="text" class="input" placeholder="Group Description" required>
                                                <label for="privacy">Group Privacy</label>
                                                <select class="form-control input" name="groupPrivacy" id="privacy">
                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                ...
                                data-demo-background="assets/img/demo/groups/1.jpg"></div>
                                ...
                                <span class="box-members">
                                    ...
                                    <div class="members-preview">
                                        ...
                                        <img src="https://via.placeholder.com/150x150"
                                            ...
                                            alt="">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/azzouz.jpg" data-user-popover="20"
                                            alt="">
                                    </div>
                                </span>
                            </div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/2.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/2.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/3.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/3.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/4.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/4.jpg"></div>
                                ...
                                <span class="box-members">
                                    ...
                                    <div class="members-preview">
                                        ...
                                        <img src="https://via.placeholder.com/150x150"
                                            ...
                                            alt="">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/mike.jpg" data-user-popover="17"
                                            alt="">
                                    </div>
                                </span>
                            </div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/5.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/5.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/6.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/6.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/7.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/7.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/8.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/8.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/9.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/9.jpg"></div>
                                ...
                                <span class="box-members">
                                    ...
                                    <div class="members-preview">
                                        <img src="https://via.placeholder.com/150x150"
                                            ...
                                            alt="">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/ken.jpg" data-user-popover="14"
                                            alt="">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/bobby.jpg" data-user-popover="8"
                                            alt="">
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/10.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/10.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/11.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/11.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/12.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/12.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/13.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/13.jpg"></div>
                            ...
                            <div class="box-info">
                                ...
                                <span class="box-members">
                                    ...
                                    <div class="members-preview">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/dan.jpg" data-user-popover="0"
                                            alt="">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/elise.jpg" data-user-popover="6"
                                            alt="">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/mike.jpg" data-user-popover="14"
                                            alt="">
                                    </div>
                                </span>
                            </div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/14.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/14.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/15.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/15.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/16.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/16.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/17.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/17.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/18.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/18.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/19.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/19.jpg"></div>
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                data-background="https://via.placeholder.com/940x650"
                                data-demo-background="assets/img/demo/groups/20.jpg"></div>
                            <a href="#" class="box-link">
                                <div class="box-img--hover has-background-image"
                                    data-background="https://via.placeholder.com/940x650"
                                    data-demo-background="assets/img/demo/groups/20.jpg"></div>
                            ...
                            <div class="box-info">
                                ...
                                <span class="box-members">
                                    ...
                                    <div class="members-preview">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/daniel.jpg" data-user-popover="5"
                                            alt="">
                                        <img src="https://via.placeholder.com/150x150"
                                            data-demo-src="assets/img/avatars/stella.jpg" data-user-popover="2"
                                            alt="">
        ...
        <div class="chat-inner">
            ...
            <div id="chat-sidebar" class="users-sidebar">
                ...
                <div class="conversations-list has-slimscroll-xs">
                    ...
                    <!-- User -->
                    <div class="user-item" data-chat-user="elise" data-full-name="Elise Walker"
                        data-status="Away">
                        <div class="avatar-container">
                            <img class="user-avatar" src="https://via.placeholder.com/300x300"
                                data-demo-src="assets/img/avatars/elise.jpg" alt="">
            ...
            <div id="chat-body" class="chat-body is-opened">
                ...
                <div id="dan-conversation" class="chat-body-inner has-slimscroll">
                    ...
                    <div class="chat-message is-sent">
                        ...
                        <div class="message-block">
                            <span>8:17am</span>
                            <div class="message-text">Great to hear it. Just send me the PSD files so i can have a
                                look at it.</div>
                        </div>
                    </div>
                ...
                <div id="david-conversation" class="chat-body-inner has-slimscroll is-hidden">
                    ...
                    <div class="chat-message is-received">
                        ...
                        <div class="message-block">
                            <span>13:09pm</span>
                            <div class="message-text">C'mon, you just gotta learn the tricks. You can't expect aliens
                                to behave like
                ...
                <div id="elise-conversation" class="chat-body-inner has-slimscroll is-hidden">
                    ...
                    <div class="chat-message is-received">
                        ...
                        <div class="message-block">
                            <span>12:19pm</span>
                            <div class="message-text">Yeah i noticed. I'll drop it in half an hour at your office.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="nelly-conversation" class="chat-body-inner has-slimscroll is-hidden">
                    ...
                    <div class="chat-message is-received">
                        ...
                        <div class="message-block">
                            <span>9:03pm</span>
                            <div class="message-text">It was so frightening, i felt my heart was about to blow inside
                                my chest.</div>
                        </div>
                    </div>
                </div>
                ...
                <div id="milly-conversation" class="chat-body-inner has-slimscroll">
                    ...
                    <div class="chat-message is-sent">
                        ...
                        <div class="message-block">
                            <span>2:02pm</span>
                            <div class="message-text">Hello Milly, Iam really sorry, Iam so busy recently, but i had
                                the time to read
                                it.</div>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="card">
                ...
                <div class="card-body has-text-centered">
                    ...
                    <p>Thanks for taking the friendkit tour. There are still tons of other features for you to discover!
                    </p>

                    <div class="action">
                        <a href="index.html#demos-section"
...
<!-- Mirrored from friendkit.cssninja.io/navbar-v1-groups.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Aug 2022 09:17:53 GMT -->
